<?php
    ...
    $sql = "SELECT cha.id_chamado as id_chamado, cha.empresa as empresa, cha.contato as contato, cha.telefone as telefone, cha.datainicio as datainicio, cha.descproblema as descproblema, usu.email as email, usu.nome as usuario FROM chamado cha LEFT JOIN usuarios usu ON usu.id = cha.usuario_id  WHERE cha.status <> 'Finalizado' ORDER BY  cha.datainicio DESC";
