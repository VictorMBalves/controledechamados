<?php
    ...
    $sql = "SELECT  chamado.empresa, chamado.sistema, count(chamado.id_chamado) as qtd, sum(TIMESTAMPDIFF(SECOND, chamado.datainicio , chamado.datafinal )) as tempo,
                    (SELECT
    ...
    $sql.=" GROUP BY chamado.empresa , chamado.sistema ";
