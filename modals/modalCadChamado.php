        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="#" method="POST">
                    ...
                    <div class="form-group">
                        <label for="descproblemachamado">Descrição do problema:</label>
                        <textarea name="descproblemachamado" id="desc_problema_chamado" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
...
$("#cadastrar").click(function() {
    versao = $("#versao");
    sistema = $("#sistema");
    descproblemachamado = $("#desc_problema_chamado");
    components = [
        empresa = $("#empresa"),
        contato = $("#contato"),
        telefone = $("#telefone")        
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.status == "success") {
                notificationSuccessLink('Registro salvo', 'Chamado registrado com sucesso!',
                    '../pages/chamados');
                window.open(
